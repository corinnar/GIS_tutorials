...
| Download the latest version of the toolbox (for ArcMap version 10.5 and 10.6) Download the toolbox instructions manual (Version  2: For ArcGIS 10.x) \ `<https://www.unredd.net/documents/global-programme-191/multiple-benefits/gis-tools-3403/17430-exploring-multiple-benefits-using-an-arcgis-10x-toolbox-instructions-and-documentation.html>`__
